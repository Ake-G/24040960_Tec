...
int main(){
	...
	printf("%7.0f %7.3f %7.1f\n",f,f,f);/*123.456000 123.456  123.5 el ultimo se
	...
	system("pause");
	//precision aplicandose a cadenas
	printf("Probando en diferentes cadenas: 10 15 y 15.5 y .5\n");
	printf("%10s %15s %15.5s %.5s",letra,letra, letra,letra);
	system("pause");
